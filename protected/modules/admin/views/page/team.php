...
<div class='row'>
	<div class='span2'>
		<?php $this->renderPartial('/page/_aside',array('action'=>'team'));?>
	</div>
	...
	<div class='span10'>
		...
		<div class='row-fluid'>
			<ul class="nav nav-tabs">
				<li <?php if( $p == 'cofounder' ){ echo 'class="active"';}?>>
					<a href="<?php echo $this->createUrl('/admin/page/team?p=cofounder');?>">
						管理团队
					</a>
				</li>
				<li <?php if( $p == 'expert' ){ echo 'class="active"';}?>>
					<a href="<?php echo $this->createUrl('/admin/page/team?p=expert');?>">
						专家顾问
					</a>
				</li>
				<li <?php if( $p == 'create' ){ echo 'class="active"';}?>>
					<a href="<?php echo $this->createUrl('/admin/page/team?p=create');?>">
						添加
					</a>
				</li>
			</ul>
